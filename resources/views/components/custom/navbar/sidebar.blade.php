...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu {{ Request::routeIs('my-profile.index') ? 'active' : '' }}">
                <a href="{{ route('my-profile.index') }}"
                    aria-expanded="{{ Request::is('*/profile/*') ? 'true' : 'false' }}"
                    class="dropdown-toggle {{ Request::is('*/profile/*') ? 'collapsed' : '' }}">
                    <div>
            ...
            @hasanyrole('admin|revenue_treasurer')
            ...
            @hasanyrole('admin|operator|ppk_staff')
                <li class="menu {{ Request::is('*/pembayaran/*') || Request::is('*/ruh-pembayaran/*') ? 'active' : '' }}">
                    ...
                    <ul class="collapse submenu list-unstyled {{ Request::is('*/pembayaran/*') || Request::is('*/ruh-pembayaran/*') ? 'show' : '' }}"
                            ...
                            <li class="submenu">
                                ...
                                <ul class="collapse list-unstyled sub-submenu {{ Request::is('*/ruh-pembayaran/*') ? 'show' : '' }}"
                                    ...
                                    <li class="{{ Request::routeIs('payment-receipt.index') ? 'active' : '' }}">
                                        <a class="ssubmenu" href="{{ route('payment-receipt.index') }}"
                                            aria-expanded="false">
                                            <div>
                        ...
                        @hasanyrole('admin|operator|ppk_staff')
                            <li class="submenu">
                                <a href="#cetakPembayaran" data-bs-toggle="collapse"
                                    aria-expanded="{{ Request::is('*/cetakPembayaran/*') ? 'true' : 'false' }}"
                                    class="dropdown-toggle {{ Request::is('*/cetakPembayaran/*') ? 'collapsed' : '' }}">
                                    <div>
                                        <i data-feather="folder"></i>
                                ...
                                <ul class="collapse list-unstyled sub-submenu {{ Request::is('*/cetakPembayaran/*') ? 'show' : '' }}"
                                    id="cetakPembayaran" data-bs-parent="#pembayaran">
                                    <li class="">
