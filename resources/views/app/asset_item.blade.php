                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center ">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-danger btn-sm" role="button"
                                                onclick="confirmDelete({{ $assetItem->id }});">
                    ...
                    <form action="{{ route('asset_item.store') }}" method="POST">
                        ...
                        <div id="asset_item-inputs" class="mt-2">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" name="asset_item_name[]" class="form-control"
                                    style="width: 22.5% !important;flex:0 1 auto !important" placeholder="Nama barang">
                                <div class="border p-2">
                                    <p class="text-dark ms-2 mb-1">Pilih Kategori</p>
                                    <div class="form-check form-check-inline mx-2">
                                        <input checked class="form-check-input" type="radio"
                                            name="asset_item_category[0]" id="asset_category_1" value="IT">
                                ...
                                <input type="text" name="asset_item_description[]" class="form-control"
