                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center ">
                                                    <button type="button" class="btn btn-sm btn-primary" onclick="openEditModal({{ $workUnit->id }}, '{{ $workUnit->name }}', '{{ $workUnit->code }}')">
                                                        <i class="text-white" data-feather="edit-2"></i>
                                                    </button>

                                                    <a href="javascript:void(0);" class="btn btn-danger btn-sm" role="button" onclick="confirmDelete({{ $workUnit->id }});">
                                                        <i class="text-white" data-feather="trash-2"></i>
                                                    </a>
                                                    <!-- Hidden form for delete request -->
                                                    <form id="delete-form-{{ $workUnit->id }}" action="{{ route('work_unit.delete', $workUnit->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
