                            ...
                            <div class="modal-body">
                                <form id="form-create" method="POST" action="{{ route('asset.store') }}">
                                    ...
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-check form-check-inline">
                                                <input checked class="form-check-input" type="radio" name="asset_item_category" id="asset_item_category_1" value="IT">
                                                <label class="form-check-label" for="asset_item_category_1">IT</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="asset_item_category" id="asset_item_category_2" value="NonIT">
                                    ...
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-sm-8">
                                            <select required class="form-select" aria-label="Pilih Barang Aset" name="asset_item" id="selectAssetItem">
                                    ...
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-sm-8">
                                            <select required name="year_acquisition" class="form-select" id="selectAcquisitionYear">
                                                ...
                                                @for ($year = 2000; $year <= 2035; $year++) <option value="{{ $year }}">{{ $year }}</option>
                                                    @endfor
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-check form-check-inline">
                                                <input checked class="form-check-input" type="radio" name="condition" id="asset_condition_1" value="good">
                                                <label class="form-check-label" for="asset_condition_1">Baik</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="condition" id="asset_condition_2" value="slightly">
                                                <label class="form-check-label" for="asset_condition_2">Rusak Ringan</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="condition" id="asset_condition_3" value="heavy">
                                    ...
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-sm-1 col-form-label">
                                            <div class="input-group-text">
                                                <input class="form-check-input mt-0 description-checkbox" type="checkbox" value="" aria-label="Enable textarea checkbox">
                                            </div>
                                        </div>
                                        <div class="col-sm-7">
                                            <div class="form-floating">
                                                <textarea disabled class="form-control" name="description" placeholder="Isikan keterangan disini" id="description" style="height: 20vh"></textarea>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            $('#assets-table').DataTable({
                                ...
                                "buttons": [{
                                        ...
                                        exportOptions: {
                                            columns: [0, 1, 2, 3, 4, 5, 6] // Indeks kolom yang ingin Anda ekspor (dimulai dari 0)
                                        },
                                        filename: function() {
                                            var d = new Date();
                                            var n = d.toISOString();
