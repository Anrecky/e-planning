                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center ">
                                                    <button type="button" class="btn btn-sm btn-primary" onclick="openEditModal({{ $user->id }}, '{{ $user->name }}', '{{ $user->email }}')">
                                                        <i class="text-white" data-feather="edit-2"></i>
                                                    </button>

                                                    <a href="javascript:void(0);" class="btn btn-danger btn-sm" role="button" onclick="confirmDelete({{ $user->id }});">
                                ...
                                <form action="{{ route('user.store') }}" method="POST">
                                    ...
                                    <div id="user-inputs" class="mt-2">
                                        <div class="input-group mb-2">
                                            ...
                                            <button type="button" onclick="togglePasswordVisibility(event)" class="btn btn-outline-secondary toggle-password">
                                ...
                                <form id="edit-form" action="" method="POST">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" id="password" placeholder="Kosongkan inputan jika ingin ubah password baru" name="password" class="form-control">
                                            <button type="button" onclick="togglePasswordVisibility(event)" class="btn btn-outline-secondary toggle-password">
                                                <i data-feather="eye" class="feather icon-eye" id="togglePassword" style="cursor: pointer;"></i>
                                            </button>
                                        </div>
