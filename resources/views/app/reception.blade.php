                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" checked name="type[]" id="inlineRadio1" value="umum">
                                                <label class="form-check-label mb-0" for="inlineRadio1">Umum</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type[]" id="inlineRadio2" value="fungsional">
                                                <label class="form-check-label mb-0" for="inlineRadio2">Fungsional</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type[]" id="inlineRadio2" value="pajak">
